...
public class Mail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("abc", "d-none");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		send("nhonquy2019@gmail.com", "1234567Aa@", "thanh@bizcom-us.com", "WUR Parts Request", message, request,
				response);
		// send("ray.biz1171@gmail.com","customerfirst","viet@bizcom-us.com","WUR Parts
		// Request",message);
	...
	public static void send(String from, String password, String to, String sub, String msg, HttpServletRequest request,
