 ...
 */
@WebServlet("/shopfloor/create_new_locations")
public class Create_New_Locations extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/views/shoop_floor/create_new_project_step_2.jsp").forward(request, response);
