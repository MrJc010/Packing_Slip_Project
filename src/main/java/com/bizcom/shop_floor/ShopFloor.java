 ...
 */
@WebServlet("/new_shopfloor_project")
public class ShopFloor extends HttpServlet {
...
//		showInput();
		...
		request.getRequestDispatcher("/WEB-INF/views/shoop_floor/shoop_floor.jsp").forward(request, response);
	}
