...
.btn {
	...
	padding: 9px 25px;
	border-width: 2px;
	box-shadow: 0 3px 8px 0 rgba(41, 49, 89, .15), inset 0 0 0 1px
		hsla(0, 0%, 100%, .1);
}
				...
				<div class="row">
					<div class="col-md-12 ">
						<div class="error-text">
							<h1 class="error">CANNOT SEND EMAIL</h1>
							<div class="im-sheep">
								<div class="top">
									<div class="body"></div>
									<div class="head">
							...
							<h4>Oops! Check your internet connection!</h4>
							<p>You cannot send email at this time. Please try it later. Contact with admin for more informaiton.</p>
							<a href="VietNB.bizcom-us.local/JSP-Servlet-AWS/mail" class="btn btn-primary btn-round">Go
								to homepage</a>
						</div>
					</div>
				</div>
