...
.form-style-6 input[type="submit"]:hover, .form-style-6 input[type="button"]:hosver
	{
	background: #2EBC99;
}
</style>
...
<body>
	<div class="form-style-6">
		...
		<form name="RMA" id="form-1" action="/physicalreceiving" method="POST">
			<input id="input-1" name="rma" placeholder="Enter RMA number"
				type="text" /><br> <input id="input-2" name="ppid"
				placeholder="Enter PPID number" type="text" /><br> <input
				id="input-3" name="dps" placeholder="Enter DPS number" type="text" /><br>
