		...
		<script>
			...
			function myFunction(count) {
				...
				while (count > 0) {
					...
					document.write('						<button class="my-5 btn btn-primary"name=\"edit' + temp +
						'\" onclick=\"enableForm()\">Edit</button>\n');
					document.write('						<form>\n');
					...
					document.write('            <input type=\"text\" class=\"form-control\" name=\"oldPN' + temp +
					...
					document.write('            <input type=\"text\" class=\"form-control\" name=\"newPN' + temp +
					...
					document.write('            <input type=\"text\" class=\"form-control\" name=\"area' + temp +
					...
					document.write('            <textarea type=\"text\" class=\"form-control\" name=\"action' + temp +
						'\" rows=\"4\" id=\"actionInput\" aria-describedby=\"emailHelp\"\n');
					document.write('              placeholder=\"Enter action\">');


					document.write('</textarea>	');
					document.write('								<button type=\"submit\" value=\"submit' + temp + '\"  name = \"submit' + temp +
